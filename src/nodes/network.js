...
(function (global) {
    ...
    class LGWebSocket extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.size = [60, 20];
            ...
            this._ws.onmessage = function (e) {
                ...
                if (data.type == 1) {
                    if (
                        ...
                        var obj = null;
                        try {
                            obj = new LiteGraph[data.data.object_class](
                                data.data
                            );
    ...
    class LGSillyClient extends LiteGraph.LGraphNode {
        constructor() {
            super();
            //this.size = [60,20];
    ...
    //HTTP Request
    class HTTPRequestNode extends LiteGraph.LGraphNode {
        constructor() {
            super();
            var that = this;
