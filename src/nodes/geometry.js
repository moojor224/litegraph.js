(function (global) {
    ...
    class LGraphPoints3D extends LiteGraph.LGraphNode {
        constructor() {
            super();
        ...
        static generatePoints(
            ...
            if (regular) {
                if (mode == LGraphPoints3D.RECTANGLE) {
                    ...
                    if (normals)
                        LGraphPoints3D.generateSphericalNormals(
                            points,
                            normals
                        );
        ...
        static generateSphere(points, size, radius) {
            for (var i = 0; i < size; i += 3) {
                ...
                var r2 = Math.random();
                var x =
                    2 * Math.cos(2 * Math.PI * r1) * Math.sqrt(r2 * (1 - r2));
                var y = 1 - 2 * r2;
                var z =
                    2 * Math.sin(2 * Math.PI * r1) * Math.sqrt(r2 * (1 - r2));
                points[i] = x * radius;
                points[i + 1] = y * radius;
                points[i + 2] = z * radius;
            }
        ...
        static generateFromObject(points, normals, size, obj, evenly) {
            ...
            for (var i = 0; i < size; i += 3) {
                ...
                var cf = t * sqrt_s;
                points[i] =
                    af * vertices[a] + bf * vertices[b] + cf * vertices[c];
                points[i + 1] =
                    af * vertices[a + 1] +
                    bf * vertices[b + 1] +
                    cf * vertices[c + 1];
    ...
    class LGraphPointsToInstances extends LiteGraph.LGraphNode {
        constructor() {
            super();
        ...
        onExecute() {
            ...
            if (
                (has_changed && this.properties.autoupdate) ||
                this.first_time
            ) {
    ...
    class LGraphGeometryTransform extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class LGraphGeometryPolygon extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class LGraphGeometryExtrude extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class LGraphGeometryEval extends LiteGraph.LGraphNode {
        constructor() {
            super();
        ...
        onExecute() {
            ...
            if (
                ...
                if (
                    !vertices ||
                    this.vertices.length != geometry.vertices.length
                )
                    vertices = this.vertices = new Float32Array(
                        geometry.vertices
                    );
...
*/
    ...
    class LGraphConnectPoints extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.addInput("in", "geometry");
            this.addOutput("out", "geometry");
    ...
    class LGraphToGeometry extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class LGraphGeometryToMesh extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.addInput("in", "geometry");
        ...
        updateMesh(geometry) {
            ...
            for (var i in geometry) {
                ...
                if (
                    !mesh_buffer ||
                    mesh_buffer.data.length != buffer_data.length
                ) {
    ...
    class LGraphRenderMesh extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.addInput("mesh", "mesh");
            this.addInput("mat4", "mat4");
    ...
    class LGraphGeometryPrimitive extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class LGraphRenderPoints extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.addInput("in", "geometry");
            this.addInput("mat4", "mat4");
        ...
        onExecute() {
            ...
            this.uniforms.u_point_perspective = this.properties.fixed_size
                ? 0
                : 1;
