...
(function (global) {
    ...
    class WidgetButton extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class WidgetToggle extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class WidgetNumber extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class WidgetCombo extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class WidgetKnob extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.addOutput("", "number");
            this.size = [64, 84];
    ...
    class WidgetSliderGUI extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.addOutput("", "number");
            this.properties = {
    ...
    //Widget H SLIDER
    class WidgetHSlider extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.size = [160, 26];
            this.addOutput("", "number");
    ...
    class WidgetProgress extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.size = [160, 26];
    ...
    class WidgetText extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.addInputs("", 0);
            this.properties = {
    ...
    class WidgetPanel extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.size = [200, 100];
            this.properties = {
