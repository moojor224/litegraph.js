(function (global) {
    ...
    class Math3DMat4 extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    //Math 3D operation
    class Math3DOperation extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class Math3DVec3Scale extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class Math3DVec3Length extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.addInput("in", "vec3");
    ...
    class Math3DVec3Normalize extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.addInput("in", "vec3");
            this.addOutput("out", "vec3");
    ...
    class Math3DVec3Lerp extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class Math3DVec3Dot extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.addInput("A", "vec3");
            this.addInput("B", "vec3");
    ...
    if (global.glMatrix) {
        class Math3DQuaternion extends LiteGraph.LGraphNode {
            constructor() {
                super();
        ...
        class Math3DRotation extends LiteGraph.LGraphNode {
            constructor() {
                super();
                this.addInputs([
                    ["degrees", "number"],
        ...
        class MathEulerToQuat extends LiteGraph.LGraphNode {
            constructor() {
                super();
        ...
        class MathQuatToEuler extends LiteGraph.LGraphNode {
            constructor() {
                super();
        ...
        //Math3D rotate vec3
        class Math3DRotateVec3 extends LiteGraph.LGraphNode {
            constructor() {
                super();
                this.addInputs([
                    ["vec3", "vec3"],
        ...
        class Math3DMultQuat extends LiteGraph.LGraphNode {
            constructor() {
                super();
                this.addInputs([
                    ["A", "quat"],
        ...
        class Math3DQuatSlerp extends LiteGraph.LGraphNode {
            constructor() {
                super();
                this.addInputs([
                    ["A", "quat"],
        ...
        //Math3D rotate vec3
        class Math3DRemapRange extends LiteGraph.LGraphNode {
            constructor() {
                super();
