(function (global) {
    ...
    class GraphicsPlot extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class GraphicsImage extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class ColorPalette extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class ImageFrame extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class ImageFade extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.addInputs([
                ["img1", "image"],
    ...
    class ImageCrop extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.addInput("", "image");
            this.addOutput("", "image");
    ...
    class CanvasNode extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class DrawImageNode extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class DrawRectangleNode extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.addInput("canvas", "canvas");
            this.addInput("x", "number");
    ...
    class ImageVideo extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    // Texture Webcam *****************************************
    class ImageWebcam extends LiteGraph.LGraphNode {
        constructor() {
            super();
