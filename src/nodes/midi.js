(function (global) {
    ...
    class LGMIDIIn extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class LGMIDIOut extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class LGMIDIShow extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class LGMIDIFilter extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.properties = {
                channel: -1,
    ...
    class LGMIDIEvent extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.properties = {
                channel: 0,
    ...
    class LGMIDICC extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.properties = {
                //		channel: 0,
    ...
    class LGMIDIGenerator extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class LGMIDITranspose extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.properties = {
                amount: 0
    ...
    class LGMIDIQuantize extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.properties = {
    ...
    class LGMIDIFromFile extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.properties = {
                url: "",
    ...
    class LGMIDIPlay extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.properties = {
                volume: 0.5,
    ...
    class LGMIDIKeys extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.properties = {
                num_octaves: 2,
