...
(function (global) {
    ...
    //Constant
    class Time extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class Subgraph extends LiteGraph.LGraphNode {
        constructor() {
            super();
            var that = this;
            this.size = [140, 80];
            ...
            this.subgraph.onOutputRemoved =
                this.onSubgraphRemovedOutput.bind(this);
        }
        onGetInputs() {
    ...
    class GraphOutput extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.addInput("", "");
    ...
    //Constant
    class ConstantNumber extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class ConstantBoolean extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class ConstantString extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class ConstantObject extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class ConstantFile extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class JSONParse extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    //to store json objects
    class ConstantData extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    //to store json objects
    class ConstantArray extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this._value = [];
            this.addInput("json", "");
    ...
    class SetArray extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class ArrayElement extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class TableElement extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class ObjectProperty extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class ObjectKeys extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.addInput("obj", "");
    ...
    class SetObject extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.addInput("obj", "");
            this.addInput("value", "");
    ...
    class MergeObjects extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    //Store as variable
    class Variable extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.size = [60, 30];
            this.addInput("in");
    ...
    class DownloadData extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.size = [60, 30];
    ...
    class Watch extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.size = [60, 30];
    ...
    class Cast extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.addInput("in", 0);
    ...
    class Console extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    //Show value inside the debug console
    class Alert extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.mode = LiteGraph.ON_EVENT;
            this.addProperty("msg", "");
    ...
    class NodeScript extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.size = [60, 30];
    ...
    class GenericCompare extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.addInput("A", 0);
            this.addInput("B", 0);
