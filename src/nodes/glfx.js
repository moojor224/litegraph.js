(function (global) {
    ...
    if (typeof GL != "undefined") {
        // Texture Lens *****************************************
        class LGraphFXLens extends LiteGraph.LGraphNode {
            constructor() {
                super();
	...
	*/
        ...
        class LGraphFXBokeh extends LiteGraph.LGraphNode {
            constructor() {
                super();
                this.addInput("Texture", "Texture");
            ...
            onExecute() {
                ...
                if (!second_shader) {
                    second_shader = LGraphFXBokeh._second_shader =
                        new GL.Shader(
                ...
                if (
                    ...
                    points_mesh = this.createPointsMesh(
                        tex.width,
                        tex.height,
                        2
                    );
	...
	*/
        ...
        class LGraphFXGeneric extends LiteGraph.LGraphNode {
            constructor() {
                super();
                this.addInput("Texture", "Texture");
            ...
            onExecute() {
                ...
                if (!shader) {
                    var pixel_shader_code =
                        LGraphFXGeneric["pixel_shader_" + fx];
        ...
        class LGraphFXVigneting extends LiteGraph.LGraphNode {
            constructor() {
                super();
