...
(function (global) {
    ...
    class LogEvent extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.size = [60, 30];
    ...
    class TriggerEvent extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.size = [60, 30];
            this.addInput("if", "");
    ...
    //Sequence of events
    class Sequence extends LiteGraph.LGraphNode {
        constructor() {
            super();
            var that = this;
    ...
    //Sequence of events
    class WaitAll extends LiteGraph.LGraphNode {
        constructor() {
            super();
            var that = this;
            this.addInput("", LiteGraph.ACTION);
    ...
    class Stepper extends LiteGraph.LGraphNode {
        constructor() {
            super();
            var that = this;
    ...
    //Filter events
    class FilterEvent extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.size = [60, 30];
            this.addInput("event", LiteGraph.ACTION);
    ...
    class EventBranch extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    //Show value inside the debug console
    class EventCounter extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    //Show value inside the debug console
    class DelayEvent extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.size = [60, 30];
    ...
    //Show value inside the debug console
    class TimerEvent extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class SemaphoreEvent extends LiteGraph.LGraphNode {
        constructor() {
            super();
    ...
    class OnceEvent extends LiteGraph.LGraphNode {
        constructor() {
            super();
            this.addInput("in", LiteGraph.ACTION);
            this.addInput("reset", LiteGraph.ACTION);
    ...
    class DataStore extends LiteGraph.LGraphNode {
        constructor() {
            super();
