...
function benchmark() {
    ...
    for (var i = 0; i < nodes.length; i++)
        nodes[(Math.random() * nodes.length) | 0].connect(
            0,
...
class TestWidgetsNode extends LiteGraph.LGraphNode {
    constructor() {
        super();
...
//Show value inside the debug console
class TestSpecialNode extends LiteGraph.LGraphNode {
    constructor() {
        super();
...
//Show value inside the debug console
class TestSlotsNode extends LiteGraph.LGraphNode {
    constructor() {
        super();
...
//Show value inside the debug console
class TestPropertyEditorsNode extends LiteGraph.LGraphNode {
    constructor() {
        super();
        this.properties = {
            name: "foo",
...
//Show value inside the debug console
class LargeInputNode extends LiteGraph.LGraphNode {
    constructor() {
        super();
